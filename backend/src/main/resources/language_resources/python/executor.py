...
if __name__ == '__main__':
    ...
    parser.add_argument('--custom-submission', action='store_true', help='Indicates that this execution is a custom submission')
    ...
    try:
        ...
        parser = Parser(problem_input_types, args.custom_submission)
        ...
        Tested_class = Problem
    except Exception as e:
        print("===ERROR===")
        print(str(e))
    else:
        if args.custom_submission:
            print("===CUSTOM_SUBMISSION===")
        else:
            print("===SUBMISSION===")
        results = []
